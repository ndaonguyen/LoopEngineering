...
COPY source/ source/
RUN dotnet restore source/LoopEngineering.Api/LoopEngineering.Api.csproj
RUN dotnet publish source/LoopEngineering.Api/LoopEngineering.Api.csproj \
...
ENTRYPOINT ["dotnet", "LoopEngineering.Api.dll"]
