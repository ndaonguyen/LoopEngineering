...
using LoopEngineering.Api.Endpoints;
using LoopEngineering.Api.Security;
using LoopEngineering.Application;
using LoopEngineering.Application.Abstractions;
using LoopEngineering.Infrastructure;
...
// Serve the React SPA built into wwwroot (see LoopEngineering.Api.csproj publish target).
app.UseDefaultFiles();
app.UseStaticFiles();
